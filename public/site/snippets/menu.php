...
<nav role="navigation" class="responsive-nav"><a href="#" class="toggle-menu">
  ...
  <ul class="menu"><?php foreach($pages->visible() as $p): ?>
    <li><a href="<?php echo $p->url() ?>" class="top-text-link"><span><?php echo htmlspecialchars($p->title()->html(), ENT_QUOTES, 'UTF-8'); ?></span>
    ...
    <li><a href="https://traitorcycles.wordpress.com" class="top-text-link"><span>Blog</span>
        <div class="underline2"></div></a></li>
  </ul><a href="#" class="primary-button pull-right">Store</a>
